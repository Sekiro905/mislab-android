...
export default class Product extends Component {
  render() {
    let {productTheme , title , supplementClass , supplement , detail , src} = this.props

    return (
      <div className={`${productTheme} item`}>
        <div className='product-img-outer'><img alt='产品介绍图片' src={require(`../../assets/${src}.png`)}></img></div>
