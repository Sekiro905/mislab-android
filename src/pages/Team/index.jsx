        ...
        <div className={styles.back}>
          ...
          <div className={styles.content}>
            <div className={styles["team-intro-outer"]}>
              <p className={styles["team-intro-outer2"]}>
                <span className={styles["team-intro"]}>
                  信管工作室成立于2008年,是一个以发展内部成员专业技能与专业素养、提升信管专业技术氛围的学生组织。不断探索、实践创新的技术体系，在十余年的成长过程当中，逐渐完善自身技术体系，扩大团队规模。我们希望并也一直在努力将一些成功经验和有趣的团队文化传播出去影响更多的人。
                </span>
              </p>
            </div>
